...
function SEO({ description, lang, meta, title }) {
  ...
  return (
    ...
    >
        ...
        <script data-name="BMC-Widget" src="https://cdnjs.buymeacoffee.com/1.0.0/widget.prod.min.js" data-id="softwarecrafts" data-description="Support naptime with Green Tea!" data-message="Thank you for your donation. Every tea helps!" data-color="#5F7FFF" data-position="left" data-x_margin="18" data-y_margin="18"></script>
    </Helmet>u
  )
}
