      ...
      <div className="relative pt-6 pb-4">
        ...
        <div className="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 xl:mt-28">
          <div className="text-center">
            <h2
              className={`text-4xl tracking-tight leading-10 font-extrabold font-serif ${theme.text.normal} sm:text-5xl sm:leading-none md:text-6xl`}
            >
              Terms &amp; Conditions
            </h2>
          </div>
...
const TermsPage = () => {
  ...
  return (
    <Layout HeroComponent={TermsHero}>
      <SEO title="Terms" />
      <div className={`relative ${theme.bg.normal} overflow-hidden ${theme.text.normal}`}>
