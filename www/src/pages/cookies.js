      ...
      <div className="mt-10 mx-auto max-w-screen-xl px-4 sm:px-6 pb-12 sm:pb-16 md:pb-20 lg:pb-28 xl:pb-32">
        <div className="text-base mt-10 mx-32">
          <p className="mt-4">
            ...
            <a className={`${theme.text.accent6} hover:no-underline underline`} href="http://naptime.app">http://naptime.app</a>. This cookie
          ...
          <p className="mt-4">
            ...
            <a className={`${theme.text.accent6} hover:no-underline underline`} href="http://naptime.app">http://naptime.app</a>, with the
